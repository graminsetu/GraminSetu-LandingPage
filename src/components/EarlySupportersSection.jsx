  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gramin-50 via-white to-setu-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-gramin-700 drop-shadow-sm">Early Supporters</h2>
        <p className="mb-10 text-gramin-800 text-lg md:text-xl font-medium">
          GraminSetu is building a digital bridge for rural India.<br />
          ...
          {supporters.map((s, idx) => (
            ...
            >
              <img
                ...
                loading="lazy"
              />
              <span className="text-base font-semibold text-gramin-700 group-hover:text-gramin-600 transition">{s.name}</span>
            </a>
          ))}
          {/* Placeholder for future supporters */}
          <div className="flex flex-col items-center bg-gray-100 rounded-2xl px-8 py-6 border border-dashed border-gramin-200 opacity-70" style={{ minWidth: 160 }}>
            <div className="h-16 w-16 bg-gray-300 rounded-full flex items-center justify-center text-3xl text-gray-500 mb-3">?</div>
        ...
        <div className="mt-4 text-xs text-gray-400">
          <a href="/terms" className="underline mr-2">Terms of Service</a>
