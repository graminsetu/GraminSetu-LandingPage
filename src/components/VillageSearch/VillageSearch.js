  ...
  return (
    <form className="flex flex-col items-center w-full max-w-md mx-auto">
      <div className="flex w-full">
        ...
        <button type="submit" className="btn-primary px-6 py-2 rounded-r-lg">Find Village</button>
      </div>
      <div className="mt-2 text-sm text-secondary-600">
        Don't see your village? <a href="/create-village" className="underline">Create New Village</a>
      </div>
    </form>
  );
};
