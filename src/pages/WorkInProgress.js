    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gramin-50 via-white to-setu-50">
      <div className="flex flex-col items-center">
        <div className="relative mb-8">
          ...
          <svg className="animate-bounce w-28 h-28 text-gramin-600" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 64 64">
        ...
        <h1 className="text-4xl font-extrabold text-gramin-700 mb-2 text-center">Under Development</h1>
        <p className="text-lg text-gramin-600 mb-6 text-center max-w-xl">This portal is currently being built. Please check back soon for exciting updates and new features!</p>
