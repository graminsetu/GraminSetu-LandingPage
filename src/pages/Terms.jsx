    ...
    <main className="flex-1 w-full max-w-4xl mx-auto py-12 px-4 md:px-8 flex flex-col items-center justify-start pt-0">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gramin-100 max-w-3xl w-full mx-auto p-8 md:p-12 animate-fade-in">
        <ol className="list-decimal list-inside text-gramin-800 text-lg space-y-6">
          <li>
            <span className="font-bold">Use of Our Services</span>
            <br />
            You agree to use GraminSetu lawfully and responsibly, respecting all applicable laws and
            regulations.
            <br />
          ...
          <li>
            ...
            <br />
            All content, trademarks, logos, software, data, and materials on GraminSetu are owned by
            or licensed to us.
            <br />
          ...
          <li>
            <span className="font-bold">User Content and Submissions</span>
            <br />
          ...
          <li>
            <span className="font-bold">Privacy and Data Protection</span>
            <br />
            We value your privacy and handle personal information in accordance with our Privacy
            Policy.
            <br />
            Please review our Privacy Policy to understand how your data is collected, used, and
            protected.
          </li>
          <li>
          ...
          <li>
            <span className="font-bold">Modifications to Services and Terms</span>
            <br />
            We reserve the right to modify or discontinue services at any time without prior notice.
            <br />
            These Terms may be updated periodically. Continued use of GraminSetu constitutes
            acceptance of the updated Terms.
          </li>
          <li>
            <span className="font-bold">Governing Law and Dispute Resolution</span>
            <br />
