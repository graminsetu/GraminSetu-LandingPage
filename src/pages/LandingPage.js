...
const LandingPage = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gramin-50 via-white to-setu-50 font-sans">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mt-[-32px] md:mt-[-48px]">
            ...
            <div className="flex-1 flex flex-col items-start text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gramin-700 mb-4 leading-tight tracking-tight drop-shadow-sm">
                {landingContent.hero.headline.split('Building').map((part, idx, arr) =>
                  idx < arr.length - 1 ? (
                    <>
                      {part}
      ...
      <section
        className="w-full flex flex-col items-center justify-center pt-2 pb-6 bg-[#f6fcf8]"
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 px-2 md:px-6">
          ...
          <div className="bg-white rounded-3xl border border-gramin-200 shadow-lg flex flex-col items-center p-10 md:p-12 -translate-y-2 transition-all duration-200 w-full min-w-0 hover:shadow-xl hover:-translate-y-2 hover:border-gramin-400">
            <div className="mb-4 pt-3">
              <svg
                className="w-12 h-12 text-gramin-600"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.2"
                viewBox="0 0 24 24"
            ...
            <div className="text-gramin-600 text-center mb-4">
              Access schemes, learn, and connect with your community.
            </div>
            <button
              className="bg-gramin-600 hover:bg-gramin-700 text-white font-bold py-2 px-6 rounded-lg transition w-full mt-auto text-center block"
              onClick={() => navigate('/work-in-progress')}
            >
              Village Portal
            </button>
          ...
          <div className="bg-white rounded-3xl border border-gramin-200 shadow-lg flex flex-col items-center p-10 md:p-12 -translate-y-2 transition-all duration-200 w-full min-w-0 hover:shadow-xl hover:-translate-y-2 hover:border-gramin-400">
            ...
            <div className="text-gramin-600 text-center mb-4">
              Discover partners, expand reach, and collaborate.
            </div>
            <button
              className="bg-gramin-600 hover:bg-gramin-700 text-white font-bold py-2 px-6 rounded-lg transition w-full mt-auto"
              onClick={() => navigate('/work-in-progress')}
            >
              Business/NGO Portal
            </button>
          ...
          <div className="bg-white rounded-3xl border border-gramin-200 shadow-lg flex flex-col items-center p-10 md:p-12 -translate-y-2 transition-all duration-200 w-full min-w-0 hover:shadow-xl hover:-translate-y-2 hover:border-gramin-400">
            ...
            <div className="text-gramin-600 text-center mb-4">
              Implement initiatives, track impact, and empower.
            </div>
            <button
              className="bg-gramin-600 hover:bg-gramin-700 text-white font-bold py-2 px-6 rounded-lg transition w-full mt-auto"
              onClick={() => navigate('/work-in-progress')}
      ...
      <section className="min-h-screen w-full flex flex-col items-center justify-center bg-[#f6fcf8] p-0 m-0">
        ...
        <div
          className="w-full max-w-7xl bg-[#eafaf1] rounded-2xl shadow-2xl border border-gramin-100 flex flex-row items-center p-14 md:p-20 justify-center"
          style={{ boxShadow: '0 12px 48px 0 #02844a22' }}
        >
          <div
          ...
          <div className="flex-1">
            <div className="font-extrabold text-3xl md:text-4xl text-gramin-800 mb-3">
              {businessModels.find((m) => m.key === selectedModel).headline}
            </div>
            <div className="text-gramin-700 text-xl mb-4">
              {businessModels.find((m) => m.key === selectedModel).brief}
            </div>
            <ul className="list-disc pl-6 text-gramin-700 text-lg mb-8">
              {businessModels
                .find((m) => m.key === selectedModel)
      ...
      <section className="py-20 bg-[#f8fcf8] flex flex-col items-center min-h-[60vh]">
        <h2 className="text-3xl md:text-4xl font-extrabold text-gramin-700 mb-4 text-center">
          Find Your Community
        </h2>
        <div className="text-lg text-gramin-600 mb-6 text-center max-w-3xl">
          Join a thriving network of villages, organizations, and changemakers. Connect,
          collaborate, and unlock new opportunities for your community, business, or government
          initiative.
        </div>
        <div
          className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl px-12 py-14 flex flex-col items-center border border-gramin-100"
          style={{ boxShadow: '0 8px 40px 0 #02844a18' }}
        >
          {/* Benefit Highlights */}
          <div className="w-full flex flex-col md:flex-row gap-4 mb-8">
            <div className="flex-1 flex items-center gap-3 bg-gramin-50 rounded-xl px-4 py-3">
              <svg
                className="w-7 h-7 text-gramin-600"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.2"
                viewBox="0 0 24 24"
            ...
            <div className="flex-1 flex items-center gap-3 bg-gramin-50 rounded-xl px-4 py-3">
              ...
              <span className="font-semibold text-gramin-700">
                For villagers, NGOs, and government
              </span>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col items-center">
            {selectedModel === 'village' && (
              <>
                ...
                <div className="text-lg text-gramin-500 mb-4 text-center">
                  Search and join your village community or create a new one.
                </div>
                ...
                <button
                  type="button"
                  className="text-gramin-500 text-sm underline hover:text-gramin-700 mt-1 bg-transparent border-0 p-0 cursor-pointer"
                >
            ...
            {selectedModel === 'business' && (
              <>
                <div className="font-bold text-2xl text-gramin-700 mb-2">
                  Find Your Business/NGO
                </div>
                <div className="text-lg text-gramin-500 mb-4 text-center">
                  Search and join your organization or register a new one.
                </div>
                <div className="w-full flex flex-col md:flex-row gap-3 mb-3">
                  <input
                    type="text"
            ...
            {selectedModel === 'government' && (
              <>
                <div className="font-bold text-2xl text-gramin-700 mb-2">
                  Find Your Department/Program
                </div>
                <div className="text-lg text-gramin-500 mb-4 text-center">
                  Search and join your department or register a new government/CSR partner.
                </div>
                <div className="w-full flex flex-col md:flex-row gap-3 mb-3">
                  <input
                    type="text"
