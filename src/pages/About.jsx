    ...
    <main className="flex-1 w-full max-w-4xl mx-auto py-16 px-4 pt-0">
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-lg text-gramin-800 text-center max-w-2xl mb-4">
          GraminSetu (“Village Bridge”) is a registered digital platform committed to advancing
          rural development by connecting communities, businesses, government bodies, and NGOs in
      ...
      <section className="mb-10">
        ...
        <p className="text-lg text-gramin-700 mb-2">
          ...
          <a
            ...
            className="underline text-gramin-600 hover:text-gramin-800"
          >
            support@graminsetu.in
          </a>{' '}
          or visit our legal policy pages.
        </p>
      </section>
    </main>
    <Footer />
