        ...
        <div className="flex justify-between items-center h-16">
          <a href="/" className="flex items-center space-x-3">
            <img
              ...
              style={{ width: 48, height: 48, marginTop: 0, marginBottom: 0 }}
            />
    ...
    <main className="flex-1 w-full max-w-4xl mx-auto py-16 px-4 pt-0">
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 text-lg text-gramin-700 space-y-1">
          <li>
            Comply fully with applicable local, national, and international laws and regulations.
          </li>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-6 text-lg text-gramin-700 space-y-1">
          <li>
            Collect, process, and store personal data only with explicit consent and for legitimate
            business purposes.
          </li>
          <li>
          ...
          <li>
            Ensure transparent communication about data use and provide users with rights to access,
        ...
        <p className="text-base text-gramin-600 mt-2">
          GraminSetu complies with the Information Technology Act, 2000 (India), and global privacy
      ...
      <section className="mb-10">
        ...
        <p className="text-base text-gramin-600 mt-2">
          We provide equal opportunities irrespective of race, caste, gender, religion, age, sexual
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-2 text-gramin-800">
          4. Anti-Corruption and Ethical Dealings
        </h2>
        <ul className="list-disc pl-6 text-lg text-gramin-700 space-y-1">
          <li>
            Strict compliance with the Prevention of Corruption Act, 1988 (India) and other relevant
            statutes.
          </li>
