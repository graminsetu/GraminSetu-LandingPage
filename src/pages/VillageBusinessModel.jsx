  ...
  <div className="bg-gramin-50 min-h-screen pb-12">
    ...
    <nav className="bg-white py-3 px-4 text-sm sticky top-0 z-10 border-b border-gramin-200">
      <ol className="flex space-x-2 text-gramin-600">
        ...
        <li>&gt;</li>
        <li>
          <Link to="/explore">Explore Business Models</Link>
        </li>
        <li>&gt;</li>
    ...
    <section className="max-w-5xl mx-auto px-4 py-10 text-center">
      ...
      <p className="text-lg text-gramin-600 mb-8">
        GraminSetu bridges the digital divide by creating an integrated village ecosystem where
        every resident enjoys seamless access to information, commerce, community engagement, and
        governance transparency. Our platform empowers villagers to take charge of their development
        and livelihood, unlocking opportunities for sustainable growth.
      </p>
    </section>
    ...
    <section className="max-w-3xl mx-auto px-4 py-6">
      <div className="bg-white rounded-xl shadow-md border border-gramin-100 p-4 flex items-center justify-center">
        <img
          src={require('../assets/business-models/village-before-after.png')}
    ...
    <section className="max-w-5xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      {features.map((f, i) => (
        <div
          key={i}
          className="flex items-start space-x-4 bg-white rounded-lg shadow p-5 border border-gramin-100"
        >
          ...
          >
            ...
            {plan.offer !== 'N/A' && (
              <div className="bg-gramin-200 text-gramin-800 px-3 py-1 rounded-full text-xs font-semibold mb-2">
                Early Bird: {plan.offer}
              </div>
            )}
            {plan.highlight && (
              <div className="text-xs text-gramin-600 font-semibold mb-2">Most Popular</div>
            )}
    ...
    <section className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside text-gramin-700 text-base space-y-2">
        <li>
          Enhance your marketplace visibility with featured listings to drive quicker sales and
          better prices.
        </li>
        <li>Receive priority support for your reported issues, ensuring faster resolution.</li>
        <li>
          Get exclusive access to workshops, government schemes, and village events designed to
          improve skills and livelihoods.
        </li>
        <li>
          Earn recognition within your community through premium badges that build trust and social
          standing.
        </li>
    ...
    <section className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ol className="list-decimal list-inside text-gramin-700 text-base space-y-2">
        <li>
          <b>Simple Onboarding:</b> Register and select your village effortlessly.
        </li>
        <li>
          <b>Explore Features:</b> Access free tools and discover premium benefits through
          contextual prompts and tutorials.
        </li>
        <li>
          <b>Seamless Upgrading:</b> Upgrade anytime with supported payment methods including UPI
          and mobile wallets.
        </li>
        <li>
          <b>Ongoing Support:</b> Dedicated help desks and community ambassadors guide you at every
          step.
        </li>
      </ol>
    </section>
    ...
    <section className="max-w-3xl mx-auto px-4 py-8 text-center">
      <h2 className="text-2xl font-bold text-gramin-900 mb-4">
        Join thousands of villagers already benefiting from GraminSetu’s digital transformation.
      </h2>
      <p className="text-lg text-gramin-700 mb-6">
        Start for free today or upgrade to premium plans to unlock your village’s full potential.
      </p>
      <Link
        to="/explore"
