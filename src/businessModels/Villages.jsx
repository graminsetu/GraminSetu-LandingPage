  ...
  <div className="bg-gramin-50 min-h-screen pb-12">
    <nav className="bg-white py-3 px-4 text-sm sticky top-0 z-10 border-b border-gramin-200">
      <ol className="flex space-x-2 text-gramin-600">
        ...
        <li>&gt;</li>
        <li>
          <a href="/explore">Explore Business Models</a>
        </li>
        <li>&gt;</li>
    ...
    <section className="max-w-5xl mx-auto px-4 py-10 text-center">
      <h1 className="text-4xl md:text-5xl font-bold text-gramin-900 mb-4">
        Explore Our Village Business Model
      </h1>
      <p className="text-xl text-gramin-700 mb-6">
        Empower Your Village Digitally — Connect, Grow, Thrive
      </p>
      <p className="text-lg text-gramin-600 mb-8">
      ...
      <img
        ...
        alt="Engaged villagers using GraminSetu"
    ...
    <section className="max-w-5xl mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold text-gramin-900 text-center mb-8">
        Flexible Pricing Plans to Suit Every Villager
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <PricingCard
          name="Premium Plus"
          features={[
            'Includes all Basic features plus featured marketplace listings, priority issue resolution, exclusive event invitations, personalized alerts, and community recognition badges for enhanced credibility.',
          ]}
          price="99"
          quarterly="270"
        ...
        <PricingCard
          ...
          features={[
            'Comprehensive access with additional benefits including personalized dashboards, job and skill training alerts, VIP event registrations, premium customer support, and advanced marketplace analytics.',
          ]}
          price="149"
          quarterly="400"
    ...
    <section className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside text-gramin-700 text-base space-y-2">
        <li>
          Maximize Marketplace Success: Showcase your products with premium listings highlighted to
          attract more buyers and increase sales speed.
        </li>
        <li>
          Priority Issue Handling: Enjoy expedited support and faster resolution of civic problems
          reported via the portal.
        </li>
        <li>
          Exclusive Access to Development Events: Participate early in government schemes, skill
          development sessions, and community workshops.
        </li>
        <li>
          Social Recognition: Build trust and reputation within your village using premium status
          badges visible to the community.
        </li>
        <li>
          Tailored Notifications: Receive customized alerts for events, government schemes,
          marketplace activities, and social initiatives that matter most to you.
        </li>
      </ul>
    </section>
    <section className="max-w-4xl mx-auto px-4 py-8">
      ...
      <ol className="list-decimal list-inside text-gramin-700 text-base space-y-2">
        ...
        <li>
          Accessible on Any Device: Mobile-first design ensures smooth navigation on smartphones,
          even with limited internet.
        </li>
        <li>
          Transparent Subscription Management: Upgrade, renew, or cancel premium plans effortlessly
          via multiple payment options including UPI, Paytm, and other popular wallets.
        </li>
        <li>
          Continuous Support: Get help from local community ambassadors, in-app assistance, and
          responsive customer support teams.
        </li>
      </ol>
    </section>
    <section className="max-w-3xl mx-auto px-4 py-8 text-center">
      <h2 className="text-2xl font-bold text-gramin-900 mb-4">
      ...
      <a
        href="/explore"
        className="inline-block px-6 py-2 rounded-full bg-gramin-600 text-white font-semibold shadow hover:bg-gramin-700 transition-colors"
      >
...
const PricingCard = ({ name, features, price, quarterly, offer, highlight }) => (
  <div
    className={`rounded-xl shadow-lg border-2 ${highlight ? 'border-gramin-600 bg-gramin-50' : 'border-gramin-200 bg-white'} p-6 flex flex-col items-center`}
  >
    ...
    {offer !== 'N/A' && (
      <div className="bg-gramin-200 text-gramin-800 px-3 py-1 rounded-full text-xs font-semibold mb-2">
        Introductory Offer: {offer}
      </div>
    )}
    {highlight && <div className="text-xs text-gramin-600 font-semibold mb-2">Most Popular</div>}
    <button className="mt-auto px-6 py-2 rounded-full bg-gramin-600 text-white font-semibold shadow hover:bg-gramin-700 transition-colors">
      Start Free
    </button>
  </div>
);
