    ...
    <div className="bg-gradient-to-br from-gramin-50 via-white to-setu-50 min-h-screen pb-12">
      ...
      <section className="max-w-5xl mx-auto px-4 py-14 text-center flex flex-col items-center">
        <h1 className="text-5xl md:text-6xl font-extrabold text-gramin-900 mb-4 leading-tight tracking-tight drop-shadow-lg bg-gradient-to-r from-gramin-600 via-gramin-400 to-setu-400 bg-clip-text text-transparent">
          Explore Our Business / NGO Model
        </h1>
        <p className="text-2xl text-gramin-700 mb-6 font-semibold">
          Empower Your Impact — Connect, Engage, Deliver
        </p>
        <p className="text-lg text-gramin-600 mb-8 max-w-3xl">
          GraminSetu’s Business and NGO portal is specially designed to empower organizations to
          extend their reach, simplify project management, and create measurable social impact
          within rural communities. Harness the power of technology to engage villagers effectively,
          manage campaigns, and drive sustainable development outcomes.
        </p>
        <div className="w-full flex justify-center mb-6">
          <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-gramin-100 bg-white">
            <img
              src={require('../assets/Before-and-after-images/bussigness b-f.png')}
              alt="GraminSetu: Empowering Business & NGO Impact"
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        <h2 className="text-4xl font-bold text-gramin-900 text-center mb-2">
          Business/NGO Portal Pricing Plans
        </h2>
        <p className="text-xl text-gramin-700 text-center mb-8">
          Transparent, Affordable Options Tailored for Impact
        </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        <h2 className="text-3xl font-bold text-gramin-900 mb-6">
          Why Choose GraminSetu’s Business / NGO Portal?
        </h2>
        <ul className="list-disc list-inside text-gramin-700 text-lg space-y-3">
          <li>
            Maximize Outreach & Impact: Efficiently engage thousands of villagers with targeted,
            data-driven communication and campaigns.
          </li>
          <li>
            Transparent Operations: Monitor donation utilization and project progress openly to
            build credibility and trust.
          </li>
          <li>
            Simplify Complex Workflows: Automate campaign management with integrated tools and APIs,
            reducing manual overhead.
          </li>
          <li>
            Scalable Solutions: Flexible plans designed to grow with your organization's ambitions
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <ol className="list-decimal list-inside text-gramin-700 text-lg space-y-3">
          ...
          <li>
            Campaign Execution: Manage large-scale initiatives with intuitive tools and
            comprehensive metrics.
          </li>
          <li>
            Effective Communication: Send personalized bulk messages and announcements targeted by
            village or demographic.
          </li>
          <li>
            Insights & Reporting: Analyze campaign performance and donation impacts through dynamic
            dashboards.
          </li>
        </ol>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-10 text-center">
        <h2 className="text-3xl font-bold text-gramin-900 mb-4">
          Transform the way your organization makes a difference.
        </h2>
        <p className="text-lg text-gramin-700 mb-6">
          Join GraminSetu’s Business/NGO platform and unlock the tools designed specifically for
          scalable, measurable rural impact.
        </p>
      </section>
    </div>
  );
