...
const features = [
  { icon: "📢", title: "Real-Time Village Updates", desc: "Stay connected with instant access to official announcements, government schemes, community news, and local events. This keeps every villager informed about opportunities and happenings within their own community." },
  { icon: "🎯", title: "Simplified Access to Government Benefits", desc: "Apply for government welfare programs, subsidies, and support initiatives directly through a user-friendly digital interface. Track your application progress with complete transparency and avoid unnecessary paperwork." },
  { icon: "🛒", title: "Vibrant Digital Marketplace", desc: "Encourage local commerce by enabling villagers to buy, sell, or exchange goods and services within a trusted marketplace built especially for their community. This not only boosts livelihoods but strengthens the local economy." },
  { icon: "🤝", title: "Dynamic Community Engagement", desc: "Participate actively in community forums, discussion groups, and event planning. Messaging features enable seamless communication among villagers, strengthening social bonds." },
  { icon: "🛠️", title: "Efficient Civic Issue Reporting", desc: "Report infrastructure issues, including water supply interruptions, sanitation concerns, and road repairs, with a simple, guided process. Receive prioritized support and quicker response times, especially as a premium user." },
  { icon: "🔍", title: "Transparent Village Governance", desc: "Access detailed village development plans, budgets, project updates, and governance decisions. Engage in village meetings virtually and contribute effectively to your community’s growth with full transparency." }
];
...
const VillageBusinessModel = () => {
  ...
  return (
    ...
    <section className="max-w-5xl mx-auto px-4 py-14 text-center flex flex-col items-center">
      <h1 className="text-5xl md:text-6xl font-extrabold text-gramin-900 mb-4 leading-tight tracking-tight drop-shadow-lg bg-gradient-to-r from-gramin-600 via-gramin-400 to-setu-400 bg-clip-text text-transparent">Explore Our Village Business Model</h1>
      <p className="text-2xl text-gramin-700 mb-6 font-semibold">Empower Your Village Digitally — Connect, Grow, Thrive</p>
    ...
    <section className="max-w-6xl mx-auto px-4 py-14">
      <h2 className="text-4xl font-bold text-gramin-900 text-center mb-8">Flexible Pricing Plans for Every Need</h2>
    ...
    <section className="max-w-4xl mx-auto px-4 py-10">
      ...
      <ul className="list-disc list-inside text-gramin-700 text-lg space-y-3">
        {whyUpgrade.map((item, i) => <li key={i}>{item}</li>)}
      </ul>
    </section>
    ...
    <section className="max-w-4xl mx-auto px-4 py-10">
      ...
      <ol className="list-decimal list-inside text-gramin-700 text-lg space-y-3">
        {userJourney.map((item, i) => <li key={i}>{item}</li>)}
      </ol>
    </section>

    {/* Call to Action */}
    <section className="max-w-3xl mx-auto px-4 py-10 text-center">
      <h2 className="text-3xl font-bold text-gramin-900 mb-4">Be part of the digital transformation shaping the future of rural India.</h2>
